...
printf("USBPD: cable detection event=%d (port %u)\r\n", (int)State, PortNum);
...
/* USER CODE BEGIN USBPD_DPM_Notification */
  ...
  switch(EventVal)
  {
    case USBPD_NOTIFY_POWER_EXPLICIT_CONTRACT :
      printf("USBPD: explicit power contract established (port %u)\r\n", PortNum);
      break;
    case USBPD_NOTIFY_REQUEST_ACCEPTED:
      printf("USBPD: power request ACCEPTED (port %u)\r\n", PortNum);
      break;
    case USBPD_NOTIFY_REQUEST_REJECTED:
      printf("USBPD: power request REJECTED (port %u)\r\n", PortNum);
      break;
    case USBPD_NOTIFY_REQUEST_WAIT:
      printf("USBPD: power request WAIT (port %u)\r\n", PortNum);
      break;
    case USBPD_NOTIFY_STATE_SNK_READY:
      printf("USBPD: SNK ready (port %u)\r\n", PortNum);
      break;
    case USBPD_NOTIFY_HARDRESET_RX:
      printf("USBPD: hard reset RX (port %u)\r\n", PortNum);
      break;
