...
/* If both doubleword and quadword programming are possible, which is the case for flashless products,
...
/* If both doubleword and quadword programming are possible, force the use of quadword for the GUI */
#if defined(FLASH_TYPEPROGRAM_DOUBLEWORD) && defined(FLASH_TYPEPROGRAM_QUADWORD)
#undef FLASH_TYPEPROGRAM_DOUBLEWORD /* Force the use of quadword for the GUI */
