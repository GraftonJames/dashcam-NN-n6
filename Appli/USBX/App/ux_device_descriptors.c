...
__ALIGN_BEGIN static uint8_t usbd_uvc_guid[16] __ALIGN_END = {DBVAL(UVC_GUID_H264),
                                                              0x00, 0x00, 0x10,
                                                              0x00, 0x80, 0x00,
                                                              0x00, 0xAA, 0x00,
                                                              0x38, 0x9B, 0x71};
                                      ...
                                      uint32_t pConf, uint32_t *Sze)
{
  ...
  *Sze += (uint32_t)sizeof(USBD_IadDescTypedef);
  ...
  __USBD_FRAMEWORK_SET_IF(pdev->tclasslist[pdev->classId].Ifs[0], 0U, 0U,
                          ...
                          USBD_DEVICE_VIDEO_PC_PROTOCOL_15,
                          0U);
  ...
  pVideoVCInDesc->wTotalLength = VC_HEADER_SIZE;
  pVideoVCInDesc->dwClockFrequency = 0;
  ...
  *Sze += (uint32_t)sizeof(USBD_VIDEOOutputTerminalDescTypeDef);
  ...
  pVideoSHeaderDesc->wTotalLength = VS_HEADER_SIZE;
  ...
  *Sze += (uint32_t)sizeof(USBD_VIDEOVSHeaderDescTypeDef);
  ...
  pVideoPayForDesc->bDescriptorSubType = UX_DEVICE_CLASS_VIDEO_VS_FORMAT_H264;
  pVideoPayForDesc->bFormatIndex = 0x1U;
  pVideoPayForDesc->bNumFrameDescriptors = 0x1U;
  pVideoPayForDesc->bDefaultFrameIndex = 0x1U;
  pVideoPayForDesc->bMaxCodecConfigDelay = 0x0U;
  pVideoPayForDesc->bmSupportedSliceModes = 0x0U;
  pVideoPayForDesc->bmSupportedSyncFrameTypes = 0x0U;
  pVideoPayForDesc->bResolutionScaling = 0x0U;
  pVideoPayForDesc->Reserved = 0x0U;
  pVideoPayForDesc->bmSupportedRateControlModes = 0x0U;
  pVideoPayForDesc->wMaxMBperSecOneResNoScal = ((UVC_FRAME_WIDTH / 16) * (UVC_FRAME_HEIGHT / 16) * UVC_CAM_FPS_HS) / 1000U;
  pVideoPayForDesc->wMaxMBperSecTwoResNoScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecThreeResNoScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecFourResNoScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecOneResTemporalScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecTwoResTemporalScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecThreeResTemporalScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecFourResTemporalScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecOneResTemporalQualityScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecTwoResTemporalQualityScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecThreeResTemporalQualityScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecFourRessTemporalQualityScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecOneResTemporalSpatialScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecTwoResTemporalSpatialScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecThreeResTemporalSpatialScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecFourResTemporalSpatialScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecOneResFullScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecTwoResFullScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecThreeRessFullScal = 0x0000;
  pVideoPayForDesc->wMaxMBperSecFourResFullScal = 0x0000;
#elif (USBD_UVC_USE_FRAME_BASE_H264 == 1U)
  pVideoPayForDesc->bDescriptorSubType = UX_DEVICE_CLASS_VIDEO_VS_FORMAT_FRAME_BASED;
  ...
  pVideoPayForDesc->bBitsPerPixel = 16;
  ...
  pVideoPayForDesc->bVariableSize = 0x01U;
#else
