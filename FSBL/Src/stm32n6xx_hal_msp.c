...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef *hxspi)
{
	...
	if (hxspi->Instance == XSPI2)
	{
		...
		PN11     ------> XSPIM_P2_IO7
		*/
		GPIO_InitStruct.Pin	  = OCTOSPI_IO2_Pin | OCTOSPI_CLK_Pin | OCTOSPI_IO4_Pin | OCTOSPI_DQS_Pin | OCTOSPI_IO1_Pin | OCTOSPI_IO3_Pin | OCTOSPI_IO5_Pin | OCTOSPI_IO0_Pin | OCTOSPI_IO6_Pin | OCTOSPI_IO7_Pin;
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef *hxspi)
{
	if (hxspi->Instance == XSPI2)
	{
		...
		PN11     ------> XSPIM_P2_IO7
		*/
		HAL_GPIO_DeInit(GPION, OCTOSPI_IO2_Pin | OCTOSPI_CLK_Pin | OCTOSPI_IO4_Pin | OCTOSPI_DQS_Pin | OCTOSPI_IO1_Pin | OCTOSPI_IO3_Pin | OCTOSPI_IO5_Pin | OCTOSPI_IO0_Pin | OCTOSPI_IO6_Pin | OCTOSPI_IO7_Pin);
