...
/* Phase 4 (USBX UVC class): Appli.bin grew to 247296 bytes (added USBX core +
 * device class + STM32 DCD driver), leaving only ~15KB headroom in Phase 3's
 * 0x40000 budget - recomputed again from the actual .bin size, with more
 * margin this time since Phase 3 also cut it close. */
#define EXTMEM_LRUN_SOURCE_SIZE 0x00050000u
